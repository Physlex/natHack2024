...
class eLDM:
    def __init__(
        ...
        self.model = model.to(
            self.device
        )  # Move the model to the device during initialization
    ...
    def generate(
        ...
        model = self.model  # Model is already on the device
