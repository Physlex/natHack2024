...
class VQModel(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx, optimizer_idx):
        ...
        if optimizer_idx == 0:
            ...
            self.log_dict(
                log_dict_ae, prog_bar=False, logger=True, on_step=False, on_epoch=True
            )
            return aeloss
        ...
        if optimizer_idx == 1:
            ...
            self.log_dict(
                log_dict_disc, prog_bar=False, logger=True, on_step=False, on_epoch=True
            )
            return discloss
...
class AutoencoderKL(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx, optimizer_idx):
        ...
        if optimizer_idx == 0:
            ...
            self.log_dict(
                log_dict_ae, prog_bar=False, logger=True, on_step=False, on_epoch=False
            )
            return aeloss
