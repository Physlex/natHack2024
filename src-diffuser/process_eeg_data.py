...
def process_eeg_data(csv_file_path, output_path="processed_eeg_data_updated.pth"):
    # Read the CSV file
    ...
    eeg_data_reshaped = eeg_data[: num_samples * time_steps].reshape(
        num_samples, 16, time_steps
    )
